package com.annisafitri.fragmentexampel1
...
import kotlinx.android.synthetic.main.book_descriptions.*

class BookDescriptions : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.book_descriptions, container,
            false)
